...
function SelectDate(obj,strFormat,execFunc)
{
    var date = new Date();
   ...
   // var by = 2010;
    ...
    cal = (cal==null) ? new Calendar(by, ey, 0, null, execFunc) : cal;    //不用每次都初始化 2006-12-03 修正
    cal.execFunc=execFunc;
...
function Calendar(beginYear, endYear, lang, dateFormatStyle, execFunc) {
  this.beginYear = 1990;
  this.endYear = 2010;
...
Calendar.prototype.draw = function() {
  ...
  obj.onclick = function () {
    ...
    calendar.execFunc && calendar.execFunc(calendar.dateControl);
    /*if(calendar.execFunc!="" && calendar.execFunc!=undefined)
        eval(calendar.execFunc+"(calendar.dateControl)");*/
    calendar.hide();
  }
