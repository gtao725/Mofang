...
{
    public class EditInBoundSoNumberByHuController : Controller
    {
        ...
        public ActionResult EditDetailSoNumber()
        {
            ...
            string result = cf.EditDetailSoNumberByHu(entity, soList.Distinct().ToArray(), poList.Distinct().ToArray(), huList.ToArray());
