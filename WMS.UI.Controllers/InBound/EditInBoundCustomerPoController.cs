...
{
    public class EditInBoundCustomerPoController : Controller
    {
        ...
        public ActionResult List()
        {
            ...
            int total = 0;
            List<WCF.InBoundService.EditInBoundResult> list = cf.EditInBoundCustomerPoList(entity, out total).ToList();
        ...
        public ActionResult EditDetailCustomerPoNumber()
        {
            ...
            string result = cf.EditDetailCustomerPoNumber(entity, soList.Distinct().ToArray(), poList.Distinct().ToArray());
